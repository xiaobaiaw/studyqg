<template>
  <div style="color: #666">
                ...
                <div style="font-size: 14px; padding: 5px 0; line-height: 25px">
                  ...
                  <div style="display: flex; line-height: 20px; margin-top: 5px">
                    ...
                    <div style="text-align: right; flex: 1">
                      ...
                      <el-button type="text" style="color: red" @click="del(subItem.id)" v-if="user.id === subItem.userId || user.role === 'ROLE_ADMIN'">删除</el-button>
                    </div>
                  </div>
                </div>   <!--  内容-->
              </div>
    ...
    <el-dialog title="回复" :visible.sync="dialogFormVisible" width="60%" >
